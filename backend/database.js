...
const addTeacher = async (id, name, age) => {
    ...
    return new Promise((resolve, reject) => {
        knex_db
            .raw(sql, [id, name, age])
            .then(() => {
                resolve({status: "Teacher added successfully"});
            })
            .catch((error) => {
                reject(error);
            });
...
const updateTeacher = async (name, age, id) => {
    ...
    return new Promise((resolve, reject) => {
        knex_db
            .raw(sql, [name, age, id])
            .then(() => {
                resolve({status: "Teacher details updated successfully"});
            })
            .catch((error) => {
                reject(error);
            });
...
const deleteTeacher = async (id) => {
    ...
    return new Promise((resolve, reject) => {
        knex_db
            .raw(sql, [id])
            .then(() => {
                resolve({status: "Teacher deleted successfully"});
            })
            .catch((error) => {
                reject(error);
            });
...
const updateStudent = async (name, age, hometown, id) => {
    ...
    return new Promise((resolve, reject) => {
        knex_db
            ...
            .then(() => {
                resolve({status: "Student details updated successfully"});
            })
            .catch((error) => {
                reject(error);
            });
